  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-5'>
        ...
        <button disabled={loading} className='bg-slate-700 text-white p-3 rounded-lg uppercase hover:opacity-90 disabled:opacity-100'>{loading ? 'Loading...' : 'Sign Up'}</button>
      </form>
      ...
      <p className='text-red-600 mt-4'>{error && "Something went wrong oops"}</p>
    </div>
  )
}
